      ...
      <div class="flex min-h-full items-center justify-center p-4">
        <div class="relative w-full max-w-4xl bg-white rounded-lg shadow-xl">
          ...
          <div class="flex items-center justify-between p-6 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-900">商品詳細資訊</h2>
            <button 
              @click="closeModal"
          ...
          <div class="p-6 space-y-6">
            ...
            <Collapsible title="銷售數量變化" :default-open="false">
              ...
              <template #badge>
                <div v-if="salesLoading" class="w-4 h-4 border-2 border-green-500 border-t-transparent rounded-full animate-spin"></div>
              </template>
            ...
            <Collapsible title="TF-IDF Top 100" :default-open="false">
              ...
              <template #badge>
                <div v-if="tfidfLoading" class="w-4 h-4 border-2 border-purple-500 border-t-transparent rounded-full animate-spin"></div>
              </template>
